...
export default function MovieDetails() {
  ...
  return (
    <>
      <TouchableOpacity onPress={router.back} className="absolute top-10 left-6 right-0 bg-dark-100 z-50 w-12 h-12 rounded-full flex items-center justify-center">
        <Image source={icons.arrow} className="size-6 rotate-180 elevation-lg" tintColor="#fff" />
      </TouchableOpacity>
        ...
        <ScrollView contentContainerStyle={{
          ...
          <View className="flex-col items-start justify-center mt-5 px-5">
            ...
            <View className="flex flex-row justify-between w-1/2">
              ...
              <MovieInfo label="Revenue" value={`${movie?.revenue ? `${Math.round(movie.budget) / 1_000_000} million` : 'N/A'}`} />
            </View>
